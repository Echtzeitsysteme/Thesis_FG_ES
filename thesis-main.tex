...
% FGES-Logo auf der Startseite
\addTitleBoxLogo*{\includegraphics[width=\linewidth,trim=-4cm 0cm -4cm 0cm]{figures/es_logo_gross.jpg}}
...
% TODO: If you write in English, change the string in the following line from "plain_doi_de" to "plain_doi"!
% TODO: Keep in mind to use "Last accessed:" instead of "Letzter Zugriff:" within your .bib file.
\bibliographystyle{plain_doi_de}
% TODO: Falls du Bugs im deutschen Literaturverzeichnis findest, melde dich bei Max.
